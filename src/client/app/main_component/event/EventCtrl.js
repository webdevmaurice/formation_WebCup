...
//console.log($(this));
        ...
        this.arrayData =    {
            offre : [
                {
                    ...
                    title_img:"FastLap Entertainment Events présente : Soirée exotique",
                    descrip:"Les soirées exotique aux Seychelles c'est les samedi soir de 23h a 5h. FAST LAP vous offre les billets VIP en utilisant nos centres de téléportation. En guest star ZENZAK en live.",
                    title_descript:"Rs 1500 par personne/ Rs 2000 pour les couples",
                    class:"ss-medium"
                },
                {
                    b_img_class:"ss-circle-1",
                    title_img:"Ministre de la culture (Ile Maurice) : L'histoire des sept îles bijoux  de l'océan indien",
                    descrip:"L'histoire c'est tous les jours en visitant les musées et places historique des îles: Maurice, Réunion Mayotte, Seychelles et Madagascar.",
                    title_descript:"Rs 500 enfant/ Rs 800 adulte",
                    class:"ss-medium"
                },
                {
                    b_img_class:"ss-circle-2",
                    title_img:"FastLap Entertainment Events présente : Week-end d'amour et de romance",
                    descrip:"Passer un magnifique week-end en amoureux dans les plus beau hotel des sept îles d'ocean Indien notamment Maurice, Rodrigues, Reunion, Grands Comores, Mayotte, Seychelles et Madagascar pour seulement Rs 7000.",
            ...
            business : [
                {
                    b_img_class:"ss-circle-team",
                    title_img:"Conférence easy international business par FASTLAP",
                    descrip:"Conférence démontrant les divers avantage a intéger FASTAP au monde du business ce vendredi 18 Julliet.",
                    title_descript:"Gratuit (un représentant par compagnie, contactez FASLAP sur le (+230) 455 88 99 pour en savoir plus.",
                    class:"ss-medium"
                },
                {
                    b_img_class:"ss-circle-1",
                    title_img:"Business Park de FAST LAP",
                    descrip:"Les business park de FAST LAP vous offres maintenant des facilité de logement, de bureau et de secrétaire expériencé a dans sur les 7 îles.",
                    title_descript:"Rs 18500 par personne/ Rs 30000 par équipe de 5 personnes (pour un durée d'une semaine",
                    class:"ss-medium"
                },
                {
                    b_img_class:"ss-circle-2",
            ...
            vacances : [
                {
                    b_img_class:"ss-circle-team",
                    title_img:"Caséla (Ile Maurice) présente : Une journée de folie",
                    descrip:"Vivez une journée de folie en participant aux activité incroyable du Caséla a l'île maurice.",
                    title_descript:"Rs 2500 par personne",
                    class:"ss-medium"
                },
                {
                    b_img_class:"ss-circle-team",
                    title_img:"FastLap Entertainment Events présente : Mes vancances en famille",
                    descrip:"Une semaine dans les plus beaux endroits de nos sept îles avec la présence d'un guide touristique.",
